...
public class ResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("lskj@2019");
        dsc.setUrl("jdbc:mysql://39.100.114.144:3306/p_ec?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
